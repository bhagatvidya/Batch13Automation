...
public class AmazonTest {
	...
	public static void main(String[] args) throws Exception {
		...
		//Click on mobile
		Thread.sleep(2000);
		WebElement clickmob=driver.findElement(By.xpath("//span[text()='iPhone 14 Plus 128GB (Product) RED']"));
		clickmob.click();
		...
		//get text of mobile and price
				...
				Thread.sleep(2000);
				//Delete cart
				WebElement delcart=driver.findElement(By.xpath("//input[@value='Delete']"));
				delcart.click();
				Thread.sleep(2000);
